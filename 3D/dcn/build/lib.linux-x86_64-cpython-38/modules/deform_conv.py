...
if __name__ == '__main__':
    ...
    deform_Conv_3D = DeformConvPack(32,32,kernel_size=(7,7,7), padding=9, dilation=3).cuda(0)
    deform_Conv_3D_exp = DeformConvPack_experimental(32,32,kernel_size=(7,7,7), padding=9, dilation=3).cuda(0)

    input = torch.rand((1,32,32,32,32))
