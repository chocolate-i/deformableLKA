...
from d_lka_former.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from d_lka_former.training.loss_functions.dice_loss import DC_and_CE_loss
from d_lka_former.training.network_training.network_trainer_synapse import NetworkTrainer_synapse
...
class Trainer_synapse(NetworkTrainer_synapse):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, seed=12345):
        """
        :param deterministic:
        ...
        """
        super(Trainer_synapse, self).__init__(deterministic, fp16, seed=seed)
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(d_lka_former.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="d_lka_former.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in d_lka_former.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old d_lka_former we would stop here. Now we add a postprocessing. This postprocessing can remove everything
