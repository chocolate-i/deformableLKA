...
from d_lka_former.training.network_training.network_trainer_acdc import NetworkTrainer_acdc
...
class Trainer_acdc(NetworkTrainer_acdc):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Trainer_acdc, self).__init__(deterministic, fp16, seed=seed)
