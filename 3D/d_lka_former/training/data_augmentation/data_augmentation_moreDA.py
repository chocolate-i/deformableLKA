...
from d_lka_former.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from d_lka_former.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params
from d_lka_former.training.data_augmentation.downsampling import DownsampleSegForDSTransform3, DownsampleSegForDSTransform2
from d_lka_former.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    if use_nondetMultiThreadedAugmenter:
        ...
        print("Using MultiThreadedAugmenter with {} threads.".format(params.get('num_threads')))
