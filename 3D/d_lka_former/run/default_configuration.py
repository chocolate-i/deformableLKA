...
from d_lka_former.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(d_lka_former.__path__[0], "training", "network_training"),
                              base_module='d_lka_former.training.network_training'):
