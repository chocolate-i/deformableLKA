...
from d_lka_former.configuration import default_num_threads
...
from d_lka_former.experiment_planning.utils import create_lists_from_splitted_dataset
from d_lka_former.network_architecture.generic_UNet import Generic_UNet
from d_lka_former.paths import *
from d_lka_former.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(d_lka_former.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="d_lka_former.preprocessing")
