...
parser.add_argument('--root_path', type=str,
                    default='./PH2/test256/', help='root dir for data')
...
snapshot_path = "./model_results_test256_ph2/{}/{}".format(args.exp, 'model')
...
if args.is_pretrain:
    ...
    net_ckpt = torch.load('/work/scratch/niggemeier/projects/transnorm/model_results/MaxViT_isic2018256/model_pretrain_epo100_bs4_lr0.01_imgsize256_s1234/best_model.pth')
