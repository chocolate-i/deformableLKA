...
parser.add_argument('--root_path', type=str,
                    default='./PH2/', help='root dir for data')
...
parser.add_argument('--is_pretrain', default=False, help='Use pretraining or not.')
...
snapshot_path = "./model_results_LKA_ph2/{}/{}".format(args.exp, 'model')
...
Net = MaxViTLKAFormer(img_size=args.img_size, num_classes=1).to(device)

if args.is_pretrain:
    print("Load pretrained skin model...")
    net_ckpt = torch.load('/work/scratch/niggemeier/projects/transnorm/model_results2018_LKA/MaxViT_isic2018224/model_pretrain_epo100_bs16_lr0.05_imgsize224_s1234/best_model.pth')
