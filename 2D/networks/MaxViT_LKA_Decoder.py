...
class MyDecoderLayer(nn.Module):
    ...
    def forward(self, x1, x2=None):
        if x2 is not None:  # skip connection exist
            ...
            tran_layer_2 = self.layer_lka_1(tran_layer_1, h, w) #LEON CHANGE THIS!
...
class MaxViTLKAFormer(nn.Module):
    def __init__(self, num_classes=9, head_count=1, token_mlp_mode="mix_skip", pretrain=True):
        super().__init__()
